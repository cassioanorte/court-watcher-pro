...
import CompletoCalc from "@/components/calculadoras/CompletoCalc";
...
const categorias: Categoria[] = [
  {
    ...
    calculadoras: [
      ...
      { id: "completo", name: "Completo", description: "Calculadora versátil: faça cálculos com índices e juros variados.", icon: FileText },
